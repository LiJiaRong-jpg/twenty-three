...
const ad = () => import('@/views/promotion/ad.vue')
const coupon = () => import('@/views/promotion/coupon.vue')
const topic = () => import('@/views/promotion/topic.vue')
const rule = () => import('@/views/promotion/groupon-rule.vue')
const activity = () => import('@/views/promotion/groupon-activity.vue')
