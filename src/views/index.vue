	...
	<div>
		...
		<el-container>
			...
			<el-container>
				...
				<el-header class="top">
					<div class="left">
						...
						<el-breadcrumb class="breadcrumb" separator="/">
							...
							<el-breadcrumb-item v-if="TITLE[1]!='首页'">{{TITLE[0]}}</el-breadcrumb-item>
							<el-breadcrumb-item v-if="TITLE[1]!='首页'">{{TITLE[1]}}</el-breadcrumb-item>
						</el-breadcrumb>
					</div>
				...
				<el-main>
					<TAB :arr="arr" @buttom='Buttom($event)' @dele="Dele($event)"></TAB>
...
<script>
	...
	export default {
		...
		methods: {
			...
			Buttom(index) { // 跳转路由
				this.TITLE = this.arr[index].name
				this.$router.push({
					path: this.arr[index].route
				}).catch(err => {
					console.log(err)
				})
			},
