			...
			<el-container class='main'>
				...
				<el-header class="top">
					...
					<div class="right">
						...
						<el-dropdown trigger="click" style="margin: 10px;" @command="handleCommand">
				...
				<el-main>
					<TAB style="width:100%" :arr="arr" @dele="Dele($event)" @CloseOther='CloseOther'
						@CloseAll="CloseAll($event)"></TAB>
